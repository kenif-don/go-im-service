...
type ChatData struct {
	...
	UnReadNo  uint32         `protobuf:"varint,7,opt,name=UnReadNo,proto3" json:"UnReadNo,omitempty"`
	LastMsg   string         `protobuf:"bytes,8,opt,name=LastMsg,proto3" json:"LastMsg,omitempty"`
	LastTime  uint64         `protobuf:"varint,9,opt,name=LastTime,proto3" json:"LastTime,omitempty"`
	Page      uint32         `protobuf:"varint,10,opt,name=Page,proto3" json:"Page,omitempty"`
	TotalPage uint32         `protobuf:"varint,11,opt,name=TotalPage,proto3" json:"TotalPage,omitempty"`
	Msgs      []*MessageData `protobuf:"bytes,12,rep,name=Msgs,proto3" json:"Msgs,omitempty"`
}
...
func (x *ChatData) GetTargetId() uint64 {
	if x != nil {
		return x.TargetId
	}
	return 0
...
func (x *ChatData) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ChatData) GetHeadImg() string {
	if x != nil {
		return x.HeadImg
	}
	return ""
...
func (x *ChatData) GetUnReadNo() uint32 {
	if x != nil {
		return x.UnReadNo
	}
	return 0
...
func (x *ChatData) GetLastMsg() string {
	if x != nil {
		return x.LastMsg
	}
	return ""
...
func (x *ChatData) GetLastTime() uint64 {
	if x != nil {
		return x.LastTime
	}
	return 0
...
func (x *ChatData) GetTotalPage() uint32 {
	if x != nil {
		return x.TotalPage
	}
	return 0
...
func (x *ChatData) GetMsgs() []*MessageData {
	if x != nil {
		return x.Msgs
	}
	return nil
...
type MessageData struct {
	...
	No       string `protobuf:"bytes,1,opt,name=No,proto3" json:"No,omitempty"`              //消息唯一编号
	Type     string `protobuf:"bytes,2,opt,name=Type,proto3" json:"Type,omitempty"`          //聊天类型 friend、group
	TargetId uint64 `protobuf:"varint,3,opt,name=TargetId,proto3" json:"TargetId,omitempty"` //聊天目标 用户ID或群ID
	UserId   uint64 `protobuf:"varint,4,opt,name=UserId,proto3" json:"UserId,omitempty"`     //当前聊天所有者
	From     string `protobuf:"bytes,5,opt,name=From,proto3" json:"From,omitempty"`          //消息发送者
	Data     string `protobuf:"bytes,6,opt,name=Data,proto3" json:"Data,omitempty"`          //消息内容 MessageData的json字符串
	Time     uint64 `protobuf:"varint,7,opt,name=Time,proto3" json:"Time,omitempty"`         //消息发送时间
	Read     int32  `protobuf:"varint,8,opt,name=Read,proto3" json:"Read,omitempty"`         //是否已阅读 1-未读 2-已读
	Send     int32  `protobuf:"varint,9,opt,name=Send,proto3" json:"Send,omitempty"`         //发送状态 1-发送中 2-发送成功 -1-发送失败
	...
	Ext4     string `protobuf:"bytes,13,opt,name=Ext4,proto3" json:"Ext4,omitempty"` //发送状态 1-发送中 2-发送成功 -1-发送失败
	Ext5     string `protobuf:"bytes,14,opt,name=Ext5,proto3" json:"Ext5,omitempty"` //是否已阅读 1-未读 2-已读
}
...
func (x *MessageData) GetNo() string {
	if x != nil {
		return x.No
	}
	return ""
...
func (x *MessageData) GetTargetId() uint64 {
	if x != nil {
		return x.TargetId
	}
	return 0
...
func (x *MessageData) GetTime() uint64 {
	if x != nil {
		return x.Time
	}
	return 0
...
func (x *MessageData) GetRead() int32 {
	if x != nil {
		return x.Read
	}
	return 0
...
func (x *MessageData) GetSend() int32 {
	if x != nil {
		return x.Send
	}
	return 0
...
func (x *MessageData) GetExt1() string {
	if x != nil {
		return x.Ext1
	}
	return ""
...
func (x *MessageData) GetExt2() string {
	if x != nil {
		return x.Ext2
	}
	return ""
...
func (x *MessageData) GetExt3() string {
	if x != nil {
		return x.Ext3
	}
	return ""
...
func (x *MessageData) GetExt4() string {
	if x != nil {
		return x.Ext4
	}
	return ""
...
func (x *MessageData) GetExt5() string {
	if x != nil {
		return x.Ext5
	}
	return ""
...
var file_service_proto_rawDesc = []byte{
	...
	0xb6, 0x02, 0x0a, 0x08, 0x43, 0x68, 0x61, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e, 0x0a, 0x02,
	...
	,
	...
	0x65, 0x22, 0x33, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x1f, 0x0a, 0x09, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x52, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x41, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x64, 0x79, 0x2a, 0x4a, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x44, 0x54, 0x4f, 0x43,
	...
	0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0xf4, 0x03, 0x12, 0x12, 0x0a, 0x0d, 0x54, 0x4f,
	0x5f, 0x49, 0x4e, 0x50, 0x55, 0x54, 0x5f, 0x50, 0x57, 0x44, 0x32, 0x10, 0xd0, 0x0f, 0x42, 0x42,
	0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x2e, 0x77, 0x6f, 0x72,
	0x6c, 0x64, 0x2e, 0x62, 0x65, 0x61, 0x6e, 0x42, 0x0f, 0x42, 0x74, 0x63, 0x41, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x0e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x2f, 0x76, 0x31, 0x3b, 0x61, 0x70, 0x69, 0xa2, 0x02, 0x05, 0x57, 0x6f, 0x72,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*MessageData)(nil),       // 4: MessageData
	(*SendResp)(nil),          // 5: SendResp
	(*ChatReq)(nil),           // 6: ChatReq
	(*FriendReq)(nil),         // 7: FriendReq
	(*SearchReq)(nil),         // 8: SearchReq
	(*FriendApplyReq)(nil),    // 9: FriendApplyReq
	(*UpdateUserReq)(nil),     // 10: UpdateUserReq
	(*UploadReq)(nil),         // 11: UploadReq
	(*UserReq)(nil),           // 12: UserReq
	(*ConfigReq)(nil),         // 13: ConfigReq
	(*ResultDTOResp)(nil),     // 14: ResultDTOResp
}
var file_service_proto_depIdxs = []int32{
	4, // 0: ChatData.Msgs:type_name -> MessageData
