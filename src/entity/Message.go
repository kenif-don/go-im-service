...
type Message struct {
	...
	Type     string `gorm:"index:idx_1" json:"type"`                 //聊天类型 friend、group  4个字段的联合索引
	TargetId uint64 `gorm:"index:idx_1" json:"targetId"`             //聊天目标 用户ID或群ID  4个字段的联合索引
	UserId   uint64 `gorm:"index:idx_1" json:"userId"`               //当前聊天所有者  4个字段的联合索引
